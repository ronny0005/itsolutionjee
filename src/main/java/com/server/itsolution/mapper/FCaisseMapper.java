...
public class FCaisseMapper extends ObjectMapper {
	...
	public static final String getCaNum
			="SELECT\tC.CA_Num\n" +
			"\t\t\t\t\t,C.CA_Intitule\n" +
			"\t\t\t\t\t\t\t\t\t,intitule = CONCAT(CONCAT(C.CA_Num,' - '),C.CA_Intitule)\n" +
			"\t\t\tFROM Z_DEPOTCAISSE A\n" +
			"\t\t\tINNER JOIN Z_DEPOTSOUCHE B\n" +
			"\t\t\tON A.DE_No=B.DE_No\n" +
			"\t\t\tINNER JOIN F_COMPTEA C\n" +
			"\t\t\tON C.CA_Num = B.CA_Num\n" +
			"\t\t\tWHERE CA_No=?";
	...
	public static final String getCaissierByCaisse 
			= "DECLARE @CA_No AS INT = ? "+
              ...
              "  WHERE 	CO.CO_Caissier=1 "+
			  "	AND 	(0 = @CA_No OR CA.CA_No = @CA_No) "+
              " GROUP BY CO.CO_No "+
			  "			,CO.CO_Nom";
	...
	public static final String getCaisseDepot
			...
			"                    GROUP BY D.DE_No,CA.CA_No,CA_Intitule,CA.CT_Num,CT_Intitule,CO_NoCaissier,JO_Num;\n" +
			"                    ELSE \n" +
			"                    SELECT\tD.DE_No\n" +
			"                            ,ISNULL(CA.CA_No,0) CA_No\n" +
			...
			"                    WHERE Prot_No=? \n" +
			"                    GROUP BY D.DE_No,CA.CA_No,IsPrincipal,CA_Intitule,CA.CT_Num,CT_Intitule,CO_NoCaissier,JO_Num;";
